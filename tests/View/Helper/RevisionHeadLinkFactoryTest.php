...
final class RevisionHeadLinkFactoryTest extends TestCase
{
    private RevisionHeadLinkFactory $object;

    /** @throws void */
    #[Override]
    protected function setUp(): void
    {
        $this->object = new RevisionHeadLinkFactory();
    }
    ...
    public function testInvoke(): void
    {
        ...
        self::assertInstanceOf(RevisionHeadLink::class, ($this->object)($container, 'test'));
    }
}
